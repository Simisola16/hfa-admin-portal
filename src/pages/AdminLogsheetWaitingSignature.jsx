...
import { 
  ...
  MapPin, User, Calendar, Tag, Shield, Clock, CheckCircle2, AlertCircle 
} from 'lucide-react';
        ...
        <div style={{ padding: '20px 24px', borderBottom: '1px solid #ffedd5', background: 'linear-gradient(135deg, #fffaf5 0%, #fff1e6 100%)', borderTopLeftRadius: '16px', borderTopRightRadius: '16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', width: '100%', maxWidth: '500px' }}>
            <div style={{ position: 'relative', width: '160px' }}>
              ...
              <ChevronDown size={14} style={{ position: 'absolute', right: '12px', top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none', color: '#c2410c' }} />
            </div>
        ...
        <div className="table-wrap" style={{ overflowX: 'auto', overflowY: 'visible', minHeight: '300px', padding: '12px' }}>
          {loading ? (
            ...
            <div className="empty-state" style={{ padding: '80px 24px' }}>
              <div className="empty-state-icon" style={{ background: '#fff7ed', color: '#ea580c', width: '64px', height: '64px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px' }}>
                <Clock size={32} />
              </div>
              <div className="empty-state-title" style={{ fontSize: '18px', fontWeight: 700, marginBottom: '8px', color: '#c2410c' }}>All Signatures Clear!</div>
              <div className="empty-state-text" style={{ fontSize: '13px', color: 'var(--text-muted)' }}>
                {searchQuery ? 'Try adjusting your search filters.' : 'There are currently no logsheets waiting for signatures.'}
              </div>
            </div>
          ) : (
            <>
