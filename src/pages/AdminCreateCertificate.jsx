      ...
      <form onSubmit={handleSubmit}>
        <div className="dual-pane-grid" style={{ gap: 24, alignItems: 'start' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            {/* CARD 2: Company & Facility Information */}
            <div className="custom-card">
              <div className="custom-card-header">
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div className="custom-card-body" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                <div>
                  ...
                  <label className="form-label" style={{ fontWeight: 700, marginBottom: 8, display: 'block' }}>
                    Search Registered Company <span style={{ color: '#ef4444' }}>*</span>
                  </label>
                    ...
                    <div style={{ border: '1px solid #e2e8f0', borderRadius: 10, overflow: 'hidden', marginBottom: 16, boxShadow: '0 4px 12px rgba(0,0,0,0.06)' }}>
                      {filteredClients.length === 0 ? (
                        <div style={{ padding: '16px', textAlign: 'center', color: '#94a3b8', fontSize: 13 }}>
                          <Search size={18} style={{ display: 'block', margin: '0 auto 6px', opacity: 0.4 }} />
                  ...
                  {selectedClient && (
                    <div style={{ border: '1.5px solid #16a34a', borderRadius: 12, overflow: 'hidden', background: '#f0fdf4', marginBottom: 16 }}>
                      <div style={{ padding: '12px 16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, borderBottom: '1px solid #dcfce7' }}>
                        ...
                        <button
                          ...
                          style={{ background: '#dcfce7', border: 'none', borderRadius: 8, padding: '5px 10px', cursor: 'pointer', color: '#15803d', fontSize: 11.5, fontWeight: 700, display: 'flex', alignItems: 'center', gap: 4, flexShrink: 0 }}
                        >
                          <X size={13} /> Change
                        </button>
                      </div>
                      ...
                      <div style={{ padding: '14px 16px', background: '#ffffff' }}>
                        <label className="form-label" style={{ fontWeight: 700, marginBottom: 6, display: 'block', fontSize: 12.5 }}>
                          Assign Certified Site / Facility <span style={{ color: '#ef4444' }}>*</span>
                        </label>
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={e => {
                                ...
                                setForm(f => ({ ...f, manufacturing_address: e.target.value }));
                              }}
                            />
                          </div>
                        )}
                  ...
                  {!clientSearchQuery.trim() && !selectedClient && (
                    <div style={{ textAlign: 'center', padding: '20px 16px', color: '#94a3b8', border: '1.5px dashed #e2e8f0', borderRadius: 12, marginBottom: 16 }}>
                      <Search size={24} style={{ display: 'block', margin: '0 auto 8px', opacity: 0.3 }} />
                      <p style={{ fontSize: 13, margin: 0, fontWeight: 500 }}>Start typing to search for a registered company</p>
                      <p style={{ fontSize: 11.5, margin: '4px 0 0', opacity: 0.7 }}>Search by company name or email address</p>
                    </div>
                  )}
                </div>
